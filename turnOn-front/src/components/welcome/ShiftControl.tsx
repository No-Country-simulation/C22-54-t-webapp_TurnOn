                    ...
                    <CarouselItem>
                        <div className="flex justify-center items-center px-4">
                            <div className="flex flex-col md:flex-row max-w-[791px] w-full">
                                <div className="md:flex md:flex-row w-full md:shadow-lg md:rounded-xl overflow-hidden">
                                    <div className="w-full md:w-[367px] h-[300px] md:h-[347px] rounded-xl shadow-lg overflow-hidden md:rounded-none md:shadow-none mb-4 md:mb-0">
                                        <img
                                    ...
                                    <div className="flex bg-secondary justify-center items-center w-full mx-auto md:w-[424px] p-10 md:p-8 rounded-xl shadow-lg md:rounded-none md:shadow-none -mt-12 md:mt-0 relative z-10 min-h-[320px] md:min-h-0">
                                        <div className="mt-24">
                                ...
                                <div className="md:flex md:flex-row w-full md:shadow-lg md:rounded-xl overflow-hidden">
                                    ...
                                    <div className="flex bg-secondary justify-center items-center w-full mx-auto md:w-[424px] p-10 md:p-8 rounded-xl shadow-lg md:rounded-none md:shadow-none -mt-12 md:mt-0 relative z-10 min-h-[320px] md:min-h-0">
                                        <div className="mt-24">
                                            ...
                                            <p className="font-roboto text-center text-p md:text-p-desktop mb-4">Wilmer Salazar</p>
